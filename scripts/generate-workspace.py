...
2. a path dependency on a crate this repository vendors keeps its path,
   rewritten to `crates/`, and gains the vendored crate's published name;
...
#
# Members are the wallet-layer crates this repository forks. The crypto stack
